 ...
 */
final class Version20230110130616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE games (id INT AUTO_INCREMENT NOT NULL, home_team_id INT DEFAULT NULL, outsider_team_id INT DEFAULT NULL, day_id INT DEFAULT NULL, home_score INT NOT NULL, outsider_score INT NOT NULL, UNIQUE INDEX UNIQ_FF232B319C4C13F6 (home_team_id), UNIQUE INDEX UNIQ_FF232B311E5D9825 (outsider_team_id), INDEX IDX_FF232B319C24126 (day_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE teams (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, championship_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, stadium VARCHAR(255) NOT NULL, coach VARCHAR(255) NOT NULL, INDEX IDX_96C22258A76ED395 (user_id), INDEX IDX_96C2225894DDBCE9 (championship_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
